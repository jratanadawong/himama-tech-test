class Api::V1::EntriesController < Api::V1::ApiController
    ...
    wrap_parameters :entry, include: [:clock_in, :clock_out, :date, :user_id, :id]
    ...
    def update
        entry = Entry.find_by_id(entry_params[:user_id])
        puts 'entry params: '
        puts entry_params
    ...
    def entry_params
        params.require(:entry).permit(:clock_in, :clock_out, :date, :user_id, :id)
    end
end